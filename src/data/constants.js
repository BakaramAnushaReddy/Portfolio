...
export const experiences = [
  {
    ...
    desc: "Worked on Digital and Emerging Payments. Solved transaction issues for refund and charge. Analysed cutomer payment behaviour use cases for specific debit card in SA(Saudi Arabia).",
    skills: [
